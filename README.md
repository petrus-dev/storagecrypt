...
## Desktop version ##
The desktop version is available [here](https://github.com/petrus-dev/storagecrypt/raw/master/storagecrypt-desktop/distributions/StorageCrypt-0.12.0.zip). It runs on Windows, Linux, and MacOS X, with Java 7.
