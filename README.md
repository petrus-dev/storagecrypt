...
## Desktop version ##
The desktop version is available here : [v0.19.0](https://github.com/petrus-dev/storagecrypt/raw/master/storagecrypt-desktop/distributions/StorageCrypt-0.19.0.zip). It runs on Windows, Linux, and MacOS X, with Java 8.
