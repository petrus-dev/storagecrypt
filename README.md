...
## Desktop version ##
The desktop version is available here : [v0.27.0](https://github.com/petrus-dev/storagecrypt/raw/master/storagecrypt-desktop/distributions/StorageCrypt-0.27.0.zip). It runs on Windows, Linux, and MacOS X, with Java 8.
