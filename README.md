...
## Desktop version ##
The desktop version is available here : [v0.21.1](https://github.com/petrus-dev/storagecrypt/raw/master/storagecrypt-desktop/distributions/StorageCrypt-0.21.1.zip). It runs on Windows, Linux, and MacOS X, with Java 8.
